...
DEFAULTS: dict[str, Any] = {
    "camera": {"source_type": "usb", "device": "/dev/video0", "width": 1280, "height": 720, "fps": 15, "bitrate": 2500000},
    "audio": {"enabled": False},
    ...
    "yolo": {"enabled": False, "model_path": "yolo11n.pt", "confidence": 0.5, "imgsz": 640, "sample_fps": 2, "alert_cooldown_seconds": 300, "target_classes": ["person"], "roi": {"x": 0, "y": 0, "width": 1, "height": 1}},
...
class AppState:
    def __init__(self):
        ...
        self.camera.select(camera["source_type"], camera.get("device"))
        self.detector = DetectionWorker(self._detection_settings, self._on_detection)
